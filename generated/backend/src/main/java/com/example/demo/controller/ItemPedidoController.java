...
/**
 * Controlador REST generado automáticamente para la entidad ItemPedido.
...
public class ItemPedidoController {
    ...
    // CREATE
    @PostMapping("/guardar")
    public ResponseEntity<ItemPedido> guardar(
            @RequestBody ItemPedido data) {
    ...
    public ResponseEntity<ItemPedido> obtenerPorId(@PathVariable Long id) {
        Optional<ItemPedido> data = service.findById(id);
    ...
    public ResponseEntity<ItemPedido> actualizar(
        ...
        ItemPedido updated = service.save(entity);
